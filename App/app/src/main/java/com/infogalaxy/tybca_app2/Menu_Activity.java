...
public class Menu_Activity extends AppCompatActivity {
    ...
    public void itemLayout(View v)
    {
        startActivity(new Intent(Menu_Activity.this,Item_Layout.class));
    }

    public void spinnerDemo(View v)
    {
        startActivity(new Intent(Menu_Activity.this,Spinner_List_Activity.class));
    }

    public void dtPickerDemo(View v)
    {
        startActivity(new Intent(Menu_Activity.this,Date_Time_Picker_Activity.class));
    }

    public void loginDemo(View v)
    {
